...
screen main_menu():
    ...
    imagemap:
        ...
        hotspot (0,300,400,120) action Start()
        hotspot (0,425,455,120) action ShowMenu("load")
        hotspot (0,550,485,120) action ShowMenu("preferences")
        hotspot (0,680,380,120) action ShowMenu("about")    
        hotspot (0,810,370,120) action ShowMenu("help")
        hotspot (0,940,325,120) action Quit(confirm = True)
